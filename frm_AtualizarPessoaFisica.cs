...
{
    public partial class frm_AtualizarPessoaFisica : Form
    {
        public frm_AtualizarPessoaFisica()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("ALTERAR_CLIENTE", con);
        ...
        {
            dgvClientesPesq.DataSource = ObterListaCPF(txtPesquisaCPF.Text);
        ...
        private void frm_AtualizarPessoaFisica_Load(object sender, EventArgs e)
        {
